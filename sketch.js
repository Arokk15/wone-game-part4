...
function setup() {
  ...
  player = createSprite(50, windowHeight / 2 + 300, 50, 50);
...
function enemy() {
  if (frameCount % 100===0) {
    ...
    en = createSprite(width + 100, Math.round(random(windowHeight / 2 + 250, height - 100)))
    en.debug = true
...
function helth() {
  rect21 = createSprite(width / 2 + 200, 10, 300, 3)
  rect212 = createSprite(width / 2 + 50, 28, 3, 40)
  push()
  noStroke()
  rect(width / 2 + 60, 19, health, 25)
  pop()
}
